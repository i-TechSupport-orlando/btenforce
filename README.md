...
A very simple launch daemon runs a script that checks if Bluetooth is turned off.  If it's off, the script turns it back on. I have found that setting the launch daemon to 5 seconds works the best. 
